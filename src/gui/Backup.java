...
public class Backup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/Memory storage.gif"))); // NOI18N
        jLabel1.setText(" ");
        ...
        buyer_insert.setText("CHOOSE LOCATION");
        ...
        buyerUpdate_insert.setText("BACKUP");
    ...
    private void buyerUpdate_insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buyerUpdate_insertActionPerformed
      Process  p =null;
        try {
            ...
            p=runtime.exec("C:/Program Files/MySQL/MySQL Server 8.0/bin/mysqldump.exe -uroot -p --add-drop-database -B agri -r"+filename);
...
//                   System.out.println("success");
            ...
            categoryExists.setText("Couldn't Create The Backup");
