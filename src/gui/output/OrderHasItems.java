...
public class OrderHasItems extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Order contains items!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrderHasItems.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
