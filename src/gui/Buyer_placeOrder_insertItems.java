...
public class Buyer_placeOrder_insertItems extends javax.swing.JFrame {
    ...
    public Buyer_placeOrder_insertItems() {
        initComponents();
        DefaultTableModel dfm=(DefaultTableModel) BuyerpurchaseOrder_orderTable.getModel();
        DefaultTableModel dtm=(DefaultTableModel) BuyerpurchaseOrder_productTable.getModel();
    ...
    private void initComponents() {
        ...
        BuyerpurchaseOrder_productID = new javax.swing.JTextField();
        BuyerpurchaseOrder_supplier = new javax.swing.JTextField();
        ...
        BuyerpurchaseOrder_productTable = new javax.swing.JTable();
        ...
        BuyerpurchaseOrder_productID.setFont(new java.awt.Font("Segoe UI Semibold", 0, 13)); // NOI18N
        BuyerpurchaseOrder_productID.setForeground(new java.awt.Color(255, 255, 255));
        BuyerpurchaseOrder_productID.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        BuyerpurchaseOrder_productID.setOpaque(false);

        BuyerpurchaseOrder_supplier.setFont(new java.awt.Font("Segoe UI Semibold", 0, 13)); // NOI18N
        BuyerpurchaseOrder_supplier.setForeground(new java.awt.Color(255, 255, 255));
        BuyerpurchaseOrder_supplier.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        BuyerpurchaseOrder_supplier.setOpaque(false);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(BuyerpurchaseOrder_supplier, javax.swing.GroupLayout.PREFERRED_SIZE, 272, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel3Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(BuyerpurchaseOrder_unitPrice)
                                ...
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addComponent(BuyerpurchaseOrder_productID, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGap(18, 18, 18)
                                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(BuyerpurchaseOrder_productID, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(BuyerjButton6, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(33, 33, 33)
                .addComponent(jLabel6)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(BuyerpurchaseOrder_supplier, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(27, 27, 27)
                .addComponent(jLabel10)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTextField1.setBounds(80, 20, 490, 40);
        ...
        BuyerpurchaseOrder_invoiceTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                " ID", "CROP NAME", "HARVEST DATE", "NEXT HARVEST DATE", "QTY", "UNIT PRICE"
            }
        ) {
        ...
        if (BuyerpurchaseOrder_invoiceTable.getColumnModel().getColumnCount() > 0) {
            ...
            BuyerpurchaseOrder_invoiceTable.getColumnModel().getColumn(5).setResizable(false);
        }
        ...
        BuyerpurchaseOrder_productTable.setFont(new java.awt.Font("Segoe UI Semibold", 0, 10)); // NOI18N
        BuyerpurchaseOrder_productTable.setForeground(new java.awt.Color(69, 69, 69));
        BuyerpurchaseOrder_productTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        BuyerpurchaseOrder_productTable.setFocusable(false);
        BuyerpurchaseOrder_productTable.setGridColor(new java.awt.Color(255, 255, 255));
        BuyerpurchaseOrder_productTable.setIntercellSpacing(new java.awt.Dimension(0, 0));
        BuyerpurchaseOrder_productTable.setRowHeight(28);
        BuyerpurchaseOrder_productTable.setSelectionBackground(new java.awt.Color(222, 191, 142));
        BuyerpurchaseOrder_productTable.setSelectionForeground(new java.awt.Color(0, 0, 0));
        BuyerpurchaseOrder_productTable.setShowVerticalLines(false);
        BuyerpurchaseOrder_productTable.getTableHeader().setReorderingAllowed(false);
        BuyerpurchaseOrder_productTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                BuyerpurchaseOrder_productTableMouseClicked(evt);
            }
        });
        jScrollPane4.setViewportView(BuyerpurchaseOrder_productTable);
        if (BuyerpurchaseOrder_productTable.getColumnModel().getColumnCount() > 0) {
            BuyerpurchaseOrder_productTable.getColumnModel().getColumn(0).setResizable(false);
            BuyerpurchaseOrder_productTable.getColumnModel().getColumn(1).setResizable(false);
        }
        ...
        BuyerpurchaseOrder_orderTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CROP ID", "CROP NAME", "QTY AVAILABLE", "UNIT PRICE"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jScrollPane3.setViewportView(BuyerpurchaseOrder_orderTable);
        if (BuyerpurchaseOrder_orderTable.getColumnModel().getColumnCount() > 0) {
            ...
            BuyerpurchaseOrder_orderTable.getColumnModel().getColumn(0).setPreferredWidth(10);
            BuyerpurchaseOrder_orderTable.getColumnModel().getColumn(1).setResizable(false);
            BuyerpurchaseOrder_orderTable.getColumnModel().getColumn(2).setResizable(false);
            BuyerpurchaseOrder_orderTable.getColumnModel().getColumn(3).setResizable(false);
        }
    ...
    private void BuyerpurchaseOrder_addToInvoiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuyerpurchaseOrder_addToInvoiceActionPerformed
        ...
        String productID=BuyerpurchaseOrder_productID.getText();
    ...
    private void BuyerjButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuyerjButton6ActionPerformed
        ...
        int selectedRow_product=BuyerpurchaseOrder_productTable.getSelectedRow();
    ...
    private void BuyerpurchaseOrder_productTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BuyerpurchaseOrder_productTableMouseClicked
        int selectedRow_product= BuyerpurchaseOrder_productTable.getSelectedRow();
        if(selectedRow_product!=-1){
            String productID=BuyerpurchaseOrder_productTable.getValueAt(selectedRow_product,0).toString();
            BuyerpurchaseOrder_productID.setText(productID);
            String supplier=BuyerpurchaseOrder_productTable.getValueAt(selectedRow_product,1).toString();
            BuyerpurchaseOrder_supplier.setText(supplier);
    ...
    }//GEN-LAST:event_BuyerpurchaseOrder_productTableMouseClicked
    ...
    private void BuyerpurchaseOrder_orderTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BuyerpurchaseOrder_orderTableMouseClicked
        int selectedRow_order=BuyerpurchaseOrder_orderTable.getSelectedRow();
        if(selectedRow_order!=-1){
            orderID=BuyerpurchaseOrder_orderTable.getValueAt(selectedRow_order,0).toString();

            BuyerpurchaseOrder_orderID.setText(orderID);
            DefaultTableModel dtm2=(DefaultTableModel) BuyerpurchaseOrder_invoiceTable.getModel();
            addItems.reloadInvoiceTable(orderID, dtm2);
            purchaseOrder_TabbedPane.setSelectedIndex(0);
    ...
    private javax.swing.JTextField BuyerpurchaseOrder_productID;
    private javax.swing.JTable BuyerpurchaseOrder_productTable;
    private javax.swing.JTextField BuyerpurchaseOrder_qty;
    private javax.swing.JTextField BuyerpurchaseOrder_supplier;
