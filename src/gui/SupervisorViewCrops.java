                    ...
                    if(bid.next()&& cid.next()){
                        try{
                            ...
                            MySQL.execute("UPDATE `block_has_crop` SET `block_b_id`='"+bid.getInt("b_id")+"' ,`crop_c_id`='"+cid.getInt("c_id")+"'"
                                    + ",`expected_yield`='"+yield+"',`no_of_crops`='"+noOfCrops+"'"
        ...
        if(blockName=="SELECT"){
            ...
            if(bid.next()&& cid.next()){
                ...
                if(rs.next()){
                    ...
                    MySQL.execute("INSERT INTO `block_has_crop`(`block_b_id`,`crop_c_id`,`from_date`,`to_date`,`expected_yield`,`no_of_crops`,`status_id`)"
                    + "VALUES ('"+bid.getInt("b_id")+"','"+cid.getInt("c_id")+"','"+from_date+"','"+to_date+"','"+yield+"','"+noOfCrops+"','1')");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                                .addComponent(idField3, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(amountCrops, javax.swing.GroupLayout.PREFERRED_SIZE, 203, javax.swing.GroupLayout.PREFERRED_SIZE))
